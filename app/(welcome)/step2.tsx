      ...
      >
        ...
        <View style={styles.illustrationContainer}>
          <View style={styles.illustrationCircle}>
            <Ionicons name="bulb" size={120} color="#FFFFFF" />
          </View>
        ...
        <View style={styles.contentContainer}>
          <Text style={styles.title}>{t('ui.welcome.step2.title')}</Text>
          <Text style={styles.subtitle}>{t('ui.welcome.step2.subtitle')}</Text>
